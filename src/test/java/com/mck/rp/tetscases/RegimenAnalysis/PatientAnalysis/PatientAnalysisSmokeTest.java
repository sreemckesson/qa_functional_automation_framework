package com.mck.rp.tetscases.RegimenAnalysis.PatientAnalysis;
    ...
    public void patAnalysisSummaryAntiGfactorsCycles() throws NoSuchElementException {
        ...
        try {
            ...
            if (rp.getNumOfGridResults() > 0) {
                ...
                //Export - Summary Page
                rp.clickButton("Export");
                rp.clickSubListItem("Detailed Patient Report (.pdf)");
                eu.syncWait(5);

                //Export - Summary Page
                rp.clickButton("Export");
                rp.clickSubListItem("Summary Patient Report (.pdf)");

                //Add Drug and Non Drug
                eu.scrollToView(rp.summaryAddDrug);
                eu.clickWhenReady(rp.summaryAddDrug, 6);
                rp.clickSubListItem("Add Drug");
    ...
    public void patAnalysisPatientInfoFilters() throws NoSuchElementException {
        ...
        try {
            ...
            if (rp.getNumOfGridResults() > 0) {
                ...
                rp.sendKeysByAction("primaryInsurance.copay", String.valueOf(new Random().nextInt(200)));
                ...
                rp.sendKeysByAction("primaryInsurance.remainingDeductible.remaining", String.valueOf(new Random().nextInt(400)));
                rp.sendKeysByAction("secondaryInsurance.remainingDeductible.remaining", String.valueOf(new Random().nextInt(250)));
