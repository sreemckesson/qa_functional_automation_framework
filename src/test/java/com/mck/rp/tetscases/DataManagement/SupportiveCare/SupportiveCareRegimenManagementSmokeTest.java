...
public class SupportiveCareRegimenManagementSmokeTest extends BaseTest {
    ...
    public void suppCareRgimenSearchAndFilters() throws NoSuchElementException {
        ...
        try {
            sa.assertTrue(rp.isLogoutExist());
            rp.clickLeftMenuItem("Data Management");
            rp.clickByLinkText("Supportive Care Regimen Management");
            sa.assertEquals(rp.getPageHeading(), "Supportive Care Regimen Management");
            sa.assertEquals(rp.getGridHeading(), "Supportive Care Regimens");
            ...
            if (rp.getNumOfGridResults() > 0) {
                ...
                for (int i = 0; i < rowCount; i++) {
                    sa.assertTrue(rp.getRowCellData(dp.supportiveCareTable, i)[0].toLowerCase().contains(srhDrug));
                }
                ...
                sa.assertNotEquals(beforeFilter, afterRegimenFilter);
                ...
                sa.assertNotEquals(beforeFilter, afterLastUpdatedByFilter);
                ...
                sa.assertEquals(rp.getPageHeading(), "Edit an Antiemetic Regimen");
                sa.assertEquals(rp.getGridHeading(), "Regimen Summary");
                ...
                sa.assertEquals(regimenDesc, summaryDesc);
                ...
                sa.assertEquals(rp.getPageHeading(), "Create a Growth Factor Regimen");
                sa.assertEquals(rp.getGridHeading(), "Regimen Summary");
                eu.scrollToBottom();
                rp.clickButton("Cancel");
                ...
                sa.assertEquals(rp.getPageHeading(), "Create an Antiemetic Regimen");
                sa.assertEquals(rp.getGridHeading(), "Regimen Summary");
                eu.scrollToBottom();
                rp.clickButton("Cancel");
            } else {
